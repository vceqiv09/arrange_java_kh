...
import exception.exam.school.Evaluation;
import exception.exam.school.Subject;
...
public class Exam {
	...
	public static void main(String[] args) {
		 ...
		 * 	가정한다. 이때 수행평가는 1 ~ 10 사이의 점수로만평가 점수를 매기며 6점 이상을 받아야
		...
		Subject greatSub = korean.greatThen(korean, math);
